                ...
                <section className="w-full bg-white py-24 z-20 relative border-t border-gray-200">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {/* Card 1: AI Solutions */}
                            <div className="bg-white rounded-[2rem] p-8 border border-gray-100 hover:border-indigo-500/50 transition-all duration-300 group flex flex-col h-full cursor-pointer hover:shadow-xl hover:-translate-y-1">
                                <div className="flex items-center gap-5 mb-8">
                                    <div className="w-16 h-16 rounded-2xl bg-[#262039] shrink-0 flex items-center justify-center shadow-sm">
                                        <svg className="w-8 h-8 text-[#818CF8]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0112 15a9.065 9.065 0 00-6.23-.693L5 14.5m14.8.8l1.402 1.402c1.232 1.232.65 3.318-1.067 3.611A48.309 48.309 0 0112 21c-2.773 0-5.491-.235-8.135-.687-1.718-.293-2.3-2.379-1.067-3.61L5 14.5"></path></svg>
                                    </div>
                                    <h3 className="text-xl md:text-2xl font-bold text-black leading-tight">Artificial Intelligence</h3>
                                </div>
                                ...
                                <div className="flex items-center justify-between text-sm font-semibold text-black group-hover:text-indigo-400 transition-colors mt-auto">
                            ...
                            <div className="bg-white rounded-[2rem] p-8 border border-gray-100 hover:border-teal-500/50 transition-all duration-300 group flex flex-col h-full cursor-pointer hover:shadow-xl hover:-translate-y-1">
                                <div className="flex items-center gap-5 mb-8">
                                    <div className="w-16 h-16 rounded-2xl bg-[#14262E] shrink-0 flex items-center justify-center shadow-sm">
                                        <svg className="w-8 h-8 text-[#2DD4BF]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"></path></svg>
                                    </div>
                                    <h3 className="text-xl md:text-2xl font-bold text-black leading-tight">Application Development</h3>
                                </div>
                                <p className="text-gray-600 leading-relaxed mb-12 flex-grow">
                                    Full-stack custom software development with modern frameworks and cloud-native architecture
                                </p>
                                <div className="flex items-center justify-between text-sm font-semibold text-black group-hover:text-teal-400 transition-colors mt-auto">
                                    <span>Learn More</span>
                                    <svg className="w-5 h-5 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-[2rem] p-8 border border-gray-100 hover:border-red-500/50 transition-all duration-300 group flex flex-col h-full cursor-pointer hover:shadow-xl hover:-translate-y-1">
                                <div className="flex items-center gap-5 mb-8">
                                    <div className="w-16 h-16 rounded-2xl bg-[#372323] shrink-0 flex items-center justify-center shadow-sm">
                                        <svg className="w-8 h-8 text-[#F87171]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                                    </div>
                                    <h3 className="text-xl md:text-2xl font-bold text-black leading-tight">Process Automation</h3>
                                </div>
                                <p className="text-gray-600 leading-relaxed mb-12 flex-grow">
                                    Comprehensive BPA, RPA, and IPA solutions to automate workflows and reduce operational costs
                                </p>
                                <div className="flex items-center justify-between text-sm font-semibold text-black group-hover:text-red-400 transition-colors mt-auto">
                                    <span>Learn More</span>
                                    <svg className="w-5 h-5 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                                </div>
                            </div>
