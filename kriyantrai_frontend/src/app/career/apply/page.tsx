...
export default function ApplyPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      payload.append("companiesWorked", formData.companiesWorked);
      ...
      setSubmitError(
        error instanceof Error ? error.message : "Unable to submit application right now."
      );
    } finally {
    ...
    <div className="flex flex-col min-h-screen bg-transparent relative z-10 w-full overflow-x-hidden">
      <main className="flex-1 pt-32 pb-16 px-4 sm:px-6 flex flex-col items-center justify-start gap-8 bg-transparent relative z-10 w-full">
        {!submitted ? (
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-black focus:bg-white focus:ring-2 focus:ring-[#153776] focus:border-[#153776] outline-none transition-all shadow-sm file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-[#153776]/10 file:text-[#153776] hover:file:bg-[#153776]/20 cursor-pointer"
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-black focus:bg-white focus:ring-2 focus:ring-[#153776] outline-none transition-all"
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-black focus:bg-white focus:ring-2 focus:ring-[#153776] outline-none transition-all appearance-none"
                    >
                ...
                <div className="pt-4">
                  <button
                    ...
                    className="w-full bg-[#153776] hover:bg-[#0d2146] disabled:bg-[#153776]/60 text-white font-bold py-4 px-6 rounded-xl transition-all shadow-lg hover:shadow-xl hover:-translate-y-1 text-lg flex items-center justify-center gap-3"
                  >
          ...
          <div className="max-w-2xl w-full mx-auto bg-white p-8 md:p-16 rounded-3xl shadow-xl border border-gray-100 flex flex-col items-center text-center gap-6 animate-in fade-in zoom-in duration-500 mb-16 mt-8">
            <div className="w-24 h-24 bg-green-100 rounded-full flex items-center justify-center mb-2 text-green-600 shadow-sm border-4 border-white ring-8 ring-green-50">
            ...
            <h3 className="text-4xl lg:text-5xl font-bold text-[#0A1629] tracking-tight mb-2">Application<br />Submitted!</h3>
            <p className="text-[#3B4D68] font-medium text-lg leading-relaxed max-w-md mb-4">
            ...
            <button
              ...
              className="bg-[#F67112] hover:bg-[#e0620c] text-white font-bold py-3.5 px-8 rounded-full transition-colors shadow-md flex items-center gap-3 text-lg"
            >
