        ...
        <div className="flex flex-col min-h-screen bg-transparent relative z-10 w-full overflow-x-hidden">
            ...
            <main className="flex-1 pt-32 pb-4 px-4 sm:px-6 flex flex-col items-center justify-start gap-12 bg-transparent relative z-10 w-full text-center">
                ...
                <div className="max-w-5xl w-full mx-auto flex flex-col items-center justify-center text-center gap-8 bg-white p-8 md:p-16 rounded-3xl shadow-xl border border-gray-100">
                    ...
                    <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-[6rem] leading-[1.0] font-bold text-black tracking-tighter mb-6">
                        Join the Makers
                    </h1>
                    ...
                    <div className="w-full flex justify-center py-2 relative group">
                        <div className="inline-flex flex-col items-center">
                            <span className="text-lg sm:text-xl md:text-2xl font-bold tracking-widest uppercase pb-2 bg-gradient-to-r from-[#14b8a6] via-[#153776] to-[#F67112] bg-clip-text text-transparent drop-shadow-sm">
                ...
                <div className="max-w-[80rem] w-full mx-auto flex flex-col gap-10 bg-transparent rounded-[2.5rem]">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="bg-blue-50/50 border border-blue-100 p-8 md:p-10 rounded-3xl card-hover-effect group text-left">
                            <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#153776] flex items-center gap-3 mb-6 font-serif">
                                <span className="text-2xl sm:text-3xl lg:text-4xl"></span> Why Join Us?
                            </h2>
                        ...
                        <div className="bg-orange-50/50 border border-orange-100 p-8 md:p-10 rounded-3xl card-hover-effect group text-left">
                            <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#153776] flex items-center gap-3 mb-6 font-serif">
                                <span className="text-2xl sm:text-3xl lg:text-4xl"></span> Who We’re Looking For
                            </h2>
                        ...
                        <div className="bg-teal-50/50 border border-teal-100 p-8 md:p-10 rounded-3xl card-hover-effect group text-left">
                            <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#153776] flex items-center gap-3 mb-6 font-serif">
                                <span className="text-2xl sm:text-3xl lg:text-4xl"></span> What You’ll Gain
                            </h2>
                    ...
                    <div className="w-full bg-indigo-50/50 border border-indigo-100 p-8 md:p-12 rounded-3xl flex flex-col md:flex-row items-center md:items-start justify-between gap-8 mt-2">
                        <div className="flex-1 text-left">
                            <h2 className="text-2xl sm:text-3xl font-bold text-[#153776] flex items-center gap-3 mb-8 font-serif">
                                <span className="text-3xl sm:text-4xl"></span> Our Culture
                            </h2>
                        ...
                        <div className="flex-1 bg-white/60 border border-indigo-200/50 p-8 rounded-3xl flex items-center justify-center text-center h-full min-h-[16rem] shadow-sm">
                            <p className="font-bold text-xl sm:text-2xl md:text-3xl leading-relaxed tracking-wide text-[#153776] italic">
                                We move fast.<br />
                                We learn faster.<br />
                                We grow together.
                            </p>
