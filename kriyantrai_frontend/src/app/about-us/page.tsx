            ...
            <main className="flex-1 w-full flex flex-col items-center justify-start pt-32 pb-0">
                ...
                <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center text-center pb-24">
                        ...
                        <div className="w-16 h-1 bg-[#F67112] mx-auto mb-16 rounded-full"></div>
                                                ...
                                                <div className="w-full overflow-hidden relative flex group [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)] [-webkit-mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)] py-4">
                            <div className="flex flex-row gap-8 min-w-max animate-marquee group-hover:[animation-play-state:paused] pr-8">
<a href="https://cini.org.uk/" target="_blank" rel="noopener noreferrer" className="bg-white rounded-[2rem] p-10 flex flex-col items-center justify-center text-center card-hover-effect group block w-[400px]">
                                ...
                                <p className="text-gray-500 text-sm leading-relaxed px-4 whitespace-normal">
                            ...
                            <a href="https://www.collidastudio.com/" target="_blank" rel="noopener noreferrer" className="bg-white rounded-[2rem] p-10 flex flex-col items-center justify-center text-center card-hover-effect group block w-[400px]">
                            ...
                            <div className="flex flex-row gap-8 min-w-max animate-marquee group-hover:[animation-play-state:paused] pr-8" aria-hidden="true">
<a href="https://cini.org.uk/" target="_blank" rel="noopener noreferrer" className="bg-white rounded-[2rem] p-10 flex flex-col items-center justify-center text-center card-hover-effect group block w-[400px]">
                                <div className="w-20 h-20 rounded-2xl bg-white shadow-sm border border-gray-100 flex items-center justify-center mb-6 p-2 transition-transform group-hover:-translate-y-1">
                                    <img src="/cini-logo-new.png" alt="CINI" className="w-full h-auto object-contain" />
                                </div>
                ...
                <div className="w-full py-24 px-4 sm:px-6 lg:px-8 flex flex-col items-center">
                    ...
                    <section className="w-full max-w-7xl mx-auto flex flex-col items-center mb-16 pt-12">
                        ...
                        <div className="w-full overflow-hidden relative flex group [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)] [-webkit-mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)] py-4">
                            <div className="flex flex-row gap-8 min-w-max animate-marquee group-hover:[animation-play-state:paused] pr-8">
                            {/* Mission */}
                            <div className="bg-white rounded-3xl p-10 flex flex-col card-hover-effect group text-left w-[350px] shrink-0">
                    ...
                    <section className="w-full max-w-7xl mx-auto flex flex-col items-center mb-16">
                        ...
                        <p className="text-gray-600 font-medium text-lg mb-16 text-center">Six compelling reasons to choose Kriyantrai as your AI transformation partner</p>
                                                ...
                                                <div className="w-full overflow-hidden relative flex group [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)] [-webkit-mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)] py-4">
                            {/* Original Marquee */}
                            <div className="flex flex-row gap-6 min-w-max animate-marquee group-hover:[animation-play-state:paused] pr-6">
                                <div className="bg-white p-8 card-hover-effect group rounded-3xl text-left flex flex-col w-[350px] shrink-0 border border-gray-100 shadow-sm hover:shadow-xl transition-shadow duration-300">
                            ...
                            <div className="flex flex-row gap-6 min-w-max animate-marquee group-hover:[animation-play-state:paused] pr-6" aria-hidden="true">
                                <div className="bg-white p-8 card-hover-effect group rounded-3xl text-left flex flex-col w-[350px] shrink-0 border border-gray-100 shadow-sm hover:shadow-xl transition-shadow duration-300">
                                    <span className="inline-block px-3 py-1 bg-teal-50 border border-teal-100 text-[#153776] text-xs font-bold rounded-full mb-6 self-start">Strategic Foundation</span>
                                    <div className="flex items-center gap-4 mb-4">
                                        <div className="w-12 h-12 shrink-0 bg-gradient-to-br from-[#14b8a6] to-[#0d9488] rounded-xl flex items-center justify-center shadow-md shadow-teal-500/20">
                    ...
                    <section className="w-full max-w-7xl mx-auto flex flex-col items-center">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full overflow-x-clip">
                            ...
                            <div 
                                ...
                                className={`bg-white border-2 rounded-3xl p-8 transition-all duration-500 flex flex-col hover:border-[#2DD4BF] hover:-translate-y-2 hover:shadow-xl ${hoveredCard === null && activeCard === 0 ? 'border-[#2DD4BF] -translate-y-2 shadow-xl' : 'border-gray-100'}`}
                            >
                                <div className="flex items-center gap-4 mb-6">
                            ...
                            <div 
                                ...
                                onMouseLeave={() => setHoveredCard(null)}
                                className={`bg-white border-2 rounded-3xl p-8 transition-all duration-500 flex flex-col hover:border-[#2DD4BF] hover:-translate-y-2 hover:shadow-xl ${hoveredCard === null && activeCard === 1 ? 'border-[#2DD4BF] -translate-y-2 shadow-xl' : 'border-gray-100'}`}
                            >
                                <div className="flex items-center gap-4 mb-6">
                                    <div className="w-16 h-16 bg-gradient-to-br from-[#14b8a6] to-[#0d9488] rounded-2xl flex items-center justify-center shrink-0 shadow-md shadow-teal-500/20">
                            ...
                            <div 
                                ...
                                onMouseLeave={() => setHoveredCard(null)}
                                className={`bg-white border-2 rounded-3xl p-8 transition-all duration-500 flex flex-col hover:border-[#2DD4BF] hover:-translate-y-2 hover:shadow-xl ${hoveredCard === null && activeCard === 2 ? 'border-[#2DD4BF] -translate-y-2 shadow-xl' : 'border-gray-100'}`}
                            >
                                <div className="flex items-center gap-4 mb-6">
                                    <div className="w-16 h-16 bg-gradient-to-br from-[#14b8a6] to-[#0d9488] rounded-2xl flex items-center justify-center shrink-0 shadow-md shadow-teal-500/20">
                            ...
                            <div 
                                ...
                                onMouseLeave={() => setHoveredCard(null)}
                                className={`bg-white border-2 rounded-3xl p-8 transition-all duration-500 flex flex-col hover:border-[#2DD4BF] hover:-translate-y-2 hover:shadow-xl ${hoveredCard === null && activeCard === 3 ? 'border-[#2DD4BF] -translate-y-2 shadow-xl' : 'border-gray-100'}`}
                            >
                                <div className="flex items-center gap-4 mb-6">
                                    <div className="w-16 h-16 bg-gradient-to-br from-[#14b8a6] to-[#0d9488] rounded-2xl flex items-center justify-center shrink-0 shadow-md shadow-teal-500/20">
