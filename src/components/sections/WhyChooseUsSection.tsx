      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 h-full">
                <div className="text-center">
                  ...
                  {/* Title */}
                  <h3 className="text-2xl font-display font-bold text-[#0A2342] mb-4 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:bg-clip-text group-hover:from-[#0A2342] group-hover:to-[#00D4FF] transition-all duration-300">
                    {reason.title}
                  </h3>
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="h-1 bg-gradient-to-r from-[#00D4FF] to-[#FF6B35] rounded-full mt-6 mx-auto max-w-24"
                ></motion.div>
              </div>
            </motion.div>
          ))}
        ...
        >
          {[
            ...
            >
              <div className="text-3xl lg:text-4xl font-display font-bold bg-gradient-to-r from-[#00D4FF] to-[#FF6B35] bg-clip-text text-transparent mb-2">
                {stat.number}
              </div>
