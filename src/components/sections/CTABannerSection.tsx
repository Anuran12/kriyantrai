...
export default function CTABannerSection() {
  return (
    <section className="relative py-32 bg-gradient-to-r from-[#0A2342] via-[#00D4FF]/20 to-[#FF6B35]/20 overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
            <Link href="/contact">
              <button className="group inline-flex items-center gap-3 px-10 py-4 bg-white text-[#0A2342] font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-300">
                Get In Touch
                <ArrowRight
                  size={20}
